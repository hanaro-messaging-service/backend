...
<head>
  ...
  <link rel="stylesheet" href="/pages/messageList/appPromotionMessageList/appPromotionMessageDetail.css" >
...
<%--            </div>--%>
    ...
    <section class="textComponent">
      ...
      <div class="buttonList">
        <a class="cancelButton" href="/pages/messageList/appPromotionMessageList/appPromotionMessageList.jsp">목록</a>
      </div>
    </section>
  </form>
</main>
