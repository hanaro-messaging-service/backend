...
<main>
    <form action="/productPromotionModifyServlet" method="POST" >
        ...
        <section class="textComponent">
            ...
            <div class="searchComponent-topBar-right">메세지 시간</div>
            <input name="prodNm" value="<%= request.getParameter("time") %>" class="textComponent-messageInput">
            <div class="searchComponent-topBar-right">메세지 발송수</div>
            <input name="prodNm" value="<%= request.getParameter("counts") %>" class="textComponent-messageInput">
