...
<head>
    <title>하나로 메세지</title>
    <link rel="stylesheet" href="/pages/sendMessage/allNotificationMessage/allNotificationMessage.css" >
    <script src="/pages/sendMessage/allNotificationMessage/allNotificationMessage.js"></script>
</head>
<body>
<header>
    헤더입니다
...
<main>
    <section class="sidebar">
        ...
        <div class="sidebar-content"><li><a href="/pages/manageMessage/allNotificationManage/allNotificationManage.jsp"> 보이스피싱 예방 안내 메시지 관리</a></li></div>
    ...
    <section class="mainComponent">
        ...
        <div class="listComponent">
            ...
            <div id="resultContainer">
                <%
                    List<allNoticePackageDTO> custInfos = (List<allNoticePackageDTO>) request.getAttribute("custInfos");
                    if (custInfos != null) {
                        for (allNoticePackageDTO custInfo : custInfos) { %>
